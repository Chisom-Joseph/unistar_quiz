...
?>
   <main>
      ...
      <div class="it-breadcrumb-area it-breadcrumb-bg" data-background="/public/img/breadcrumb/breadcrumb.jpg">
         <div class="container">
            <div class="row ">
               <div class="col-md-12">
               ...
               <div class="col-xl-6 col-lg-6">
                  <div class="it-about-4-thumb-wrap d-flex align-items-center justify-content-center justify-content-lg-end">
                     <div class="it-about-4-thumb-double d-flex flex-column">
                        <img class="mb-20" src="/public/img/about/thumb-4-1.jpg" alt="">
                        <img src="/public/img/about/thumb-4-2.jpg" alt="">
                     </div>
                     <div class="it-about-4-thumb-single">
                        <img src="/public/img/about/thumb-4-3.jpg" alt="">
                     </div>
                  </div>
               </div>
               <div class="col-xl-6 col-lg-6">
      ...
      <div class="it-funfact-area z-index-5">
         <div class="container">
            <div class="it-funfact-bg-wrap theme-bg" data-background="/public/img/funfact/funfact-bg.png">
               <div class="row gx-0">
      ...
      <div class="it-testimonial-area it-testimonial-ptb it-sub-bg-none it-testimonial-bg fix p-relative" data-background="/public/img/testimonial/testimonial-bg.jpg">
         <div class="it-testimonial-shape-1 d-none d-xl-block">
            <img src="/public/img/testimonial/shape-2-1.png" alt="">
         </div>
         <div class="container">
      ...
      <div class="it-course-area it-sub-bg-none p-relative grey-bg pt-120 pb-120">
         <div class="it-course-shape-1 d-none d-xl-block">
            <img src="/public/img/course/shape-1-1.png" alt="">
         </div>
         <div class="it-course-shape-2 d-none d-xxl-block">
            <img src="/public/img/course/shape-1-2.png" alt="">
         </div>
         <div class="it-course-shape-3 d-none d-xl-block">
            <img src="/public/img/course/shape-1-3.png" alt="">
         </div>
         <div class="it-course-shape-4 d-none d-xl-block">
            <img src="/public/img/course/shape-1-4.png" alt="">
         </div>
         <div class="container">
            <div class="row">
               <div class="col-xl-12">
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                  <div class="it-course-item">
                     ...
                     <div class="it-course-content">
                        ...
                        <h4 class="it-course-title pb-5"><a href="course-details.html">It statistics data science and Business analysis</a></h4>
               ...
               <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                  <div class="it-course-item">
                     ...
                     <div class="it-course-content">
                        ...
                        <h4 class="it-course-title pb-5"><a href="#">It statistics data science and Business analysis</a></h4>
                        <div class="it-course-info pb-15 mb-25 d-flex justify-content-between">
                           <span><i class="fa-light fa-file-invoice"></i>Lesson 10</span>
                           <span><i class="fa-sharp fa-regular fa-clock"></i>19h 30m</span>
                           <span><i class="fa-light fa-user"></i>Students 20+</span>
      ...
      <div class="it-team-3-area p-relative z-index pt-110 pb-90">
         <div class="it-team-3-bg" data-background="/public/img/team/bg-4.png"></div>
         <div class="container">
            <div class="row">
               <div class="col-xl-12">
